		...
		<view :id="id">
			<scroll-view scroll-x class="u-scroll-view" :scroll-left="scrollLeft" scroll-with-animation>
				<view class="u-scroll-box" :class="{'u-tabs-scorll-flex': !isScroll}">
					<view class="u-tab-item u-line-1" :id="'u-tab-item-' + index" 
					v-for="(item, index) in list" :key="index" @tap="clickTab(index)"
					v-if="isShow(item)"
...
<script>
	...
	export default {
		...
		methods: {
			...
			isShow(_item){
				if (typeof _item[this.showFieldName] == 'undefined'){
					return true
				}
				else{
					return _item[this.showFieldName]
				}
			}
		},
		mounted() {
